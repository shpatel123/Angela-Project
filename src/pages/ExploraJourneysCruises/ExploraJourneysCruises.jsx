...
const inclusions = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1545987796-200677ee1011?w=900&q=80",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1567473030492-533b30c5494c?w=900&q=80",
    ...
    <div className={`aac-expert-grid${inView ? " aac-animate-in" : ""}`}>
      ...
      <div className="aac-expert-left">
        ...
        <p className="aac-expert-desc" style={{ marginTop: "18px" }}>
          Explora Journeys appeals strongly to travelers seeking a more refined,
          spacious, and contemporary luxury cruise experience.
        </p>

        <blockquote className="aac-expert-quote">
          “Explora Journeys especially resonates with affluent travelers who
          feel traditional luxury cruising has become either too formal or too
          commercialized.”
        </blockquote>

        <p className="aac-expert-desc" style={{ marginTop: "24px" }}>
          Angela Hughes frequently notes that Explora successfully blends modern
          European sophistication with a calmer and more personalized onboard
          atmosphere.
        </p>
      ...
      <div className="aac-expert-right">
        <p className="aac-insight-label">
          What Luxury Travelers Love Most
        </p>
...
<section className="Scenic_hero_section">
  ...
  <div className="Scenic_hero_content">
    ...
    <p>
      ...
      suites. They want meaningful value, exceptional service, and a genuinely
      elevated experience from the moment they board.
    </p>

    <p>
      That is exactly why travelers continue asking one important question:
      “What is actually included on Explora Journeys cruises?”
    </p>
    ...
    {readMore && (
      <>
        ...
        <p>
          Unlike traditional premium cruise lines that add constant onboard
          charges, Explora Journeys was designed to create a seamless luxury
          lifestyle-at-sea experience with far fewer surprise expenses.
        </p>

        <p>
          According to luxury cruise expert Angela Hughes, one of the biggest
          reasons affluent travelers are gravitating toward Explora Journeys is
          the line’s balance between refined European luxury and transparent
          value.
        </p>

        <p>
          With more than 40 years in the travel industry, travel experience
          ...
          Hughes has become one of the most trusted voices in luxury cruising
          worldwide.
        </p>
      </>
    )}
    ...
    <section className="Ejc-section">
      <div className="Ejc-container">
        ...
        <div className="Ejc-header">
          ...
          <h2 className="Ejc-title">What Is Included in an <br /> Explora Journeys Cruise Fare?</h2>
           <div className="adg-accent-line"></div>
          <p className="Ejc-subtitle">
            Explora Journeys includes significantly more than many luxury travelers expect.
          </p>
        ...
        <div className="Ejc-layout">
          ...
          <div className="Ejc-panel" key={active}>
            ...
            <div className="Ejc-img-wrap">
              <img src={current.image} alt={current.title} className="Ejc-img" />
    ...
    <div className="adg-c-why-grid">
      ...
      <div className="adg-c-why-left">
        ...
        <p className="adg-c-lead adg-c-lead-light">
          Even highly inclusive luxury cruise lines still have optional premium
          expenses travelers should plan for in advance.
        </p>
        ...
        <p
            className="adg-c-lead adg-c-lead-light"
          >
            According to Angela Hughes, one of the most common mistakes luxury
            travelers make is assuming all luxury cruise lines include the same
            things. In reality, inclusions vary significantly between brands.
          </p>
      </div>
      ...
      <div className="adg-c-why-right" style={{ marginTop: "41px" }}>
        <div className="adg-c-why-card">
          ...
          <p className="adg-c-why-card-desc">
            Even with strong luxury inclusions, these experiences often remain
            additional:
          </p>
      ...
      <div className="adg-content-card-side">
        ...
        <div className="adg-info-card">
          ...
          <p className="adg-card-subtext">
            Explora Journeys is best described as “Luxury inclusive” rather
            than fully ultra-all-inclusive.
          </p>
          ...
          <div className="Adg-expert-credentials-grid">
            {[
              ...
              },
              {
                icon: <Award size={16} />,
                label:
                  "Featured in major travel publications worldwide",
              },
              {
                icon: <Ship size={16} />,
                label:
...
<section className="Ejc-section Ejc-planning-section">
  <div className="Ejc-container">
    {/* HEADER */}
    <div className="Ejc-header">
        ...
        <div className="Ejc-feature-list">
          {[
            ...
            <div key={i} className="Ejc-feature-item">
              <span className="Ejc-feature-icon">
                {item.icon}
              </span>

              <span className="Ejc-feature-text">
                {item.text}
              </span>
            </div>
          ))}
        ...
        <div className="Ejc-benefits-grid">
          {[
            ...
            <div key={i} className="Ejc-benefit-card">
              <div className="Ejc-benefit-icon">
                {item.icon}
              </div>

              <span className="Ejc-benefit-label">
                {item.label}
              </span>
            </div>
          ))}
    ...
    <div className="Avr-planning-grid">
      ...
      <div className="Avr-planning-left">
        ...
        <div className="Avr-planning-alert">
          ...
          <p className="Avr-planning-alert-text">
            That positioning is precisely why many affluent travelers compare
            Explora Journeys more closely to upscale private yacht
      ...
      <div className="Avr-planning-right">
        <p className="Avr-planning-right-intro">
          Instead of emphasizing mass-market experiences, Explora focuses on:
        </p>
        ...
        >
          ...
          quieter, more refined, and contemporary approach to luxury cruising.
        </p>
      </div>
    </div>
  </div>
...
<section className="Ejv-verdict-section" style={{ backgroundColor: "var(--bg-soft)" }}>
