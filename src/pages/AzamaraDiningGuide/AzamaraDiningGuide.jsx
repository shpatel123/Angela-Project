...
const diningOverview = [
  {
    ...
    label: "Complimentary main dining venues",
  },
...
const diningData = [
  {
    ...
    items: ["Aqualina", "Wine-pairing dinners", "Sunset dining on the patio"],
...
const schemaData = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      description: "Expert luxury cruise dining guide for Azamara Cruises.",
    },
    {
      "@type": "FAQPage",
      mainEntity: [
...
const AzamaraDiningGuide = () => {
  ...
  return (
    <div className="Asc-page-wrapper">
      <Helmet>
        <title>
          Azamara Dining Guide 2026 | Best Restaurants, Specialty Dining &
          Expert Cruise Tips
        </title>
        <meta
          name="title"
      ...
      <section className="Scenic_hero_section">
        ...
        <div className="Scenic_hero_content">
          ...
          <p>
            Discover Why Azamara Dining Is One of Luxury Cruising’s Best Kept
            Secrets
          </p>
          <p>
            For travelers who believe exceptional cuisine is one of the defining
            elements of luxury travel, Azamara Cruises offers a surprisingly
            refined culinary experience that consistently exceeds expectations.
          </p>
          ...
          {readMore && (
            <>
              <p>
                Unlike mega-ships that focus on quantity and spectacle, Azamara
                delivers a more intimate, destination-inspired dining philosophy
                centered around quality, regional authenticity, and relaxed
                sophistication.
              </p>

              <p>
                At Trips & Ships Luxury Travel, luxury cruise expert Angela
                Hughes has spent decades helping travelers identify which cruise
                experiences truly align with their lifestyle and expectations.
                With more than 40 years in the travel industry and visits to
                over 121 countries, Angela’s expertise helps travelers navigate
                the luxury cruise landscape with confidence.
              </p>

              <p>
                As CEO of Trips & Ships Luxury Travel, founder of Luxury Travel
                University, Travel Leaders Network Advisory Board member, and
                recipient of the 2024 Luxury Travel Influencer of the Year
                award, Angela brings unmatched industry perspective to luxury
                cruise planning.
              </p>
            </>
          )}
          ...
          <div className="adg-c-why-grid">
            ...
            <div className="adg-c-why-left">
              ...
              <p className="adg-c-body adg-c-body-light">
                ...
                For sophisticated travelers seeking immersive luxury travel
                rather than flashy mega-ship entertainment, Azamara's culinary
                approach often becomes one of the cruise's most memorable
                highlights.
              </p>
            </div>
            ...
            <div className="adg-c-why-right">
              <div className="adg-c-why-card">
                <span className="adg-c-why-card-label">
                  Azamara's smaller ships create:
                </span>
              ...
              <div key={venue.id} className="adg-c-specialty-card">
                <div className="adg-c-specialty-header">
                  <div className="adg-c-specialty-header-top">
                    <span className="adg-c-specialty-eyebrow">
                      {venue.eyebrow}
                    </span>
                  ...
                  {venue.items.map((item, j) => (
                    <li key={j}>
                      <Check
                        size={15}
                        strokeWidth={2.5}
                        className="adg-c-specialty-check"
                      />
                      <span>{item}</span>
                    </li>
                  ))}
                ...
                <div className="adg-c-worth-note">
                  ...
                  <div className="adg-c-worth-note-content">
                    <p className="adg-c-worth-note-text">
                      ...
                      feels mandatory to escape mediocre included food,
                      Azamara's complimentary dining is already very strong.
                    </p>
      ...
      <section className="adg-section" id="adg-dining">
        <div className="adg-container">
          ...
          <div className="adg-header">
            ...
            <h2 className="adg-h2">
              Best Azamara Dining Experiences by Traveler Type
            </h2>
            <div className="adg-accent-line"></div>
            <p className="adg-intro">
              Azamara's dining philosophy adapts to every travel style — from
              intimate couples' evenings to flexible family meals. Discover
              which experience suits your journey.
            </p>
          </div>
        ...
        <div className="Asc-container">
          <div className="Asc-section-header">
            ...
            <p className="Asc-section-intro">
              Azamara occupies an appealing middle ground between premium and
      ...
      <section className="Avr-planning-section" id="Asc-planning-advice">
        <div className="Asc-container">
          ...
          <div className="Avr-planning-heading">
            <span className="Avr-planning-eyebrow">Expert Insights</span>
          ...
          <div className="Avr-planning-grid">
            ...
            <div className="Avr-planning-left">
              ...
              <p className="Avr-planning-left-body">
                According to Angela Hughes, one of the biggest misconceptions
                about Azamara is that travelers underestimate the culinary
                sophistication onboard.
              </p>
              ...
              <div className="Avr-planning-alert">
                ...
                <p className="Avr-planning-alert-text">
                  After decades of luxury cruise experience and extensive global
                  travel, Angela frequently recommends Azamara to travelers
                  seeking authentic, destination-inspired luxury cruising.
                </p>
              </div>
            </div>
            ...
            <div className="Avr-planning-right">
              ...
              <div className="Avr-planning-benefits-grid">
                {[
                  {
                    icon: <MapPin size={18} />,
                    label: "Want destination immersion",
                  },
                  { icon: <Ship size={18} />, label: "Prefer smaller ships" },
                  {
                    icon: <Award size={18} />,
                    label: "Value authentic cuisine",
                  },
                  {
                    icon: <Users size={18} />,
                    label: "Dislike overcrowded mega-ships",
                  },
                  {
                    icon: <Star size={18} />,
                    label: "Appreciate relaxed luxury",
                  },
                ].map((item, i) => (
              ...
              >
                Her clients frequently report that Azamara’s dining experience
                feels more intimate and authentic than many larger luxury cruise
                competitors.
              </p>
            </div>
          </div>
      ...
      >
        <div className="adg-container">
          ...
          <div className="adg-intro-wrapper" style={{ marginBottom: "40px" }}>
            <p className="adg-intro-text">Azamara performs well with:</p>
          </div>

          <div
            className="adg-appeals-feature-grid"
          ...
          <div className="adg-split-layout">
            ...
            <div className="adg-content-card-side">
              ...
              <div className="adg-info-card">
                ...
                <p className="adg-card-subtext">
                  These itineraries allow regional cuisine onboard to align
                  beautifully with destinations visited.
                </p>
              </div>
            </div>
            ...
            <div className="adg-list-side">
              {[
                ...
                {
                  title: "Spain & Portugal sailings",
                  icon: <MapPin size={20} />,
                },
                { title: "Greek Isles cruises", icon: <Ship size={20} /> },
                {
                  title: "Italy-focused itineraries",
                  icon: <Star size={20} />,
                },
                {
                  title: "South American wine-region cruises",
                  icon: <Wine size={20} />,
                },
              ].map((item, i) => (
        ...
        <div className="Asc-container">
          ...
          <div className="Asc-who-grid">
            ...
            <div className="Asc-who-card Asc-who-yes">
              <h3 className="Asc-who-title">Best For Travelers Who:</h3>
            ...
            <div className="Asc-who-card Asc-who-no">
              <h3 className="Asc-who-title">Not Ideal For Travelers Who:</h3>
            ...
            <div className="Asc-help-content">
              <div className="Asc-help-header">
                ...
                <h2 className="Asc-help-h2">
                  Plan Your Perfect Azamara Cruise
                </h2>
              ...
              <div className="Asc-help-grid">
                <div className="Asc-help-info">
                  <p className="Asc-help-intro">
                    Choosing the right Azamara itinerary, ship, suite category,
                    and dining strategy can dramatically shape your cruise
                    experience.
                  </p>

                  <p className="Asc-help-intro">
                    At Trips & Ships Luxury Travel, Angela Hughes and her team
                    provide personalized luxury cruise planning tailored to your
                    travel style, culinary preferences, and destination goals.
                  </p>
                ...
                <div className="Asc-help-list-box">
                  ...
                  <p className="Asc-help-intro" style={{ marginTop: "20px" }}>
                    Trips & Ships Luxury Travel can help create a seamless
                    luxury journey from beginning to end.
                  </p>
                </div>
              </div>
            </div>
