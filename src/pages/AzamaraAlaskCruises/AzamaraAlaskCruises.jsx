...
const aacFeelItems = [
  {
    ...
    title: "Glaciers & Champagne",
    text: "Sipping champagne while glaciers calve into icy waters from your intimate ship deck.",
  },
  {
    icon: <Eye size={22} strokeWidth={1.5} />,
    title: "Private Veranda Views",
    text: "Watching humpback whales breach from your private veranda in the open Pacific.",
  },
  {
    icon: <Timer size={22} strokeWidth={1.5} />,
    title: "Arrive Before the Crowds",
    text: "Arriving in charming coastal towns before larger ships — a genuine Azamara advantage.",
  },
  {
    icon: <Utensils size={22} strokeWidth={1.5} />,
    title: "Destination Cuisine",
    text: "Destination-focused cuisine inspired by Pacific Northwest and Alaskan regional flavors.",
  },
  {
    icon: <Sparkles size={22} strokeWidth={1.5} />,
    title: "Personalized Luxury",
    text: "Returning from wilderness adventures to genuinely personalized luxury service every evening.",
  },
  {
    icon: <Mountain size={22} strokeWidth={1.5} />,
    title: "Curated, Not Commercial",
    text: "An Alaska experience that feels curated and intimate rather than commercialized.",
  },
];
...
const aacInsightPoints = [
  {
    num: "01",
    text: "Ship size matters enormously for the feeling onboard and in port",
  },
  {
    num: "02",
    text: "Itinerary design determines what you actually get to experience",
  },
  {
    num: "03",
    text: "Glacier access varies significantly between vessels and routes",
  },
  {
    num: "04",
    text: "Port timing shapes whether you experience a town or a crowd",
  },
  {
    num: "05",
    text: "Onboard atmosphere defines the overall quality of the journey",
  },
];
...
const aacMonths = [
  ...
  },
  {
    name: "Aug",
    peak: false,
    highlights: ["Whale watching", "Lush scenery", "Prime photography"],
  },
  {
    name: "Sept",
    peak: false,
...
const aacExtensions = [
  {
    ...
    label: "Luxury rail journeys",
    sub: "Through the Alaskan wilderness",
  },
  {
    icon: <TreePine size={20} strokeWidth={1.5} />,
    label: "Wilderness lodges",
    sub: "For deeper nature immersion",
  },
  {
    icon: <Compass size={20} strokeWidth={1.5} />,
    label: "Private guided land tours",
    sub: "Before or after sailing",
  },
  {
    icon: <Mountain size={20} strokeWidth={1.5} />,
    label: "Canadian Rockies extensions",
    sub: "Via Banff or Jasper",
  },
];
        ...
        <div className={`aac-expert-grid${inView ? " aac-animate-in" : ""}`}>
          <div className="aac-expert-left">
            ...
            <h2 className="aac-h2 aac-h2-white">
              What Luxury Travelers Often Misunderstand About Alaska Cruises
            </h2>
            <div className="aac-accent-line aac-accent-white" />
            <blockquote className="aac-expert-quote">
              One of the biggest misconceptions is that all Alaska cruises feel
              similar. Alaska is one destination where smaller ships often
          ...
          <div className="aac-expert-right">
            <p className="aac-insight-label">
              What actually differs between sailings
            </p>
  ...
  return (
    <section className="aac-section aac-section-timing" ref={ref}>
      <div className="aac-container">
        ...
        <div
          className={`aac-months-full-grid${inView ? " aac-animate-in" : ""}`}
        >
          {aacMonths.map((m, i) => (
            <div
              key={i}
              className={`aac-month-card${m.peak ? " aac-month-card-peak" : ""}`}
        ...
        <div className={`aac-itin-layout${inView ? " aac-animate-in" : ""}`}>
          <div className="aac-itin-left">
            ...
            <div className="aac-ports-cloud">
              {aacPorts.map((p, i) => (
                <span key={i} className="aac-port-tag">
                  {p}
                </span>
              ))}
            </div>
          ...
          <div className="aac-itin-right">
            <p className="aac-itin-col-label">
              Popular pre &amp; post extensions
            </p>
            <div className="aac-extensions-list">
              {aacExtensions.map((e, i) => (
                <div
                  key={i}
                  className="aac-extension-item"
                  style={{ animationDelay: `${i * 0.09}s` }}
                >
                  <span className="aac-extension-icon" aria-hidden="true">
                    {e.icon}
                  </span>
                  <div>
...
const AzamaraAlaskCruises = () => {
  ...
  return (
    <div className="Asc-page-wrapper">
      <Helmet>
        <title>
          Azamara Alaska Cruises | Luxury Alaska Small Ship Cruises With Expert
          Guidance
        </title>
        <meta
          name="title"
      ...
      <section className="aac_hero_section">
        ...
        <div className="aac_hero_content">
          ...
          <p className="aac_hero_text">
            Alaska is not simply a cruise destination. For luxury travelers, it
            is one of the world’s last truly immersive frontiers — a place where
            towering glaciers, remote wilderness, whale-filled waters, and
            untouched landscapes create experiences that feel profoundly rare.
          </p>

          {readMore && (
            <>
              <p className="aac_hero_text">
                An Azamara Alaska cruise offers something many larger cruise
                lines cannot: intimacy, destination immersion, personalized
                service, and a more refined way to experience Alaska’s dramatic
                beauty.
              </p>

              <p className="aac_hero_text">
                At Trips & Ships Luxury Travel, luxury cruise expert Angela
                Hughes helps discerning travelers navigate Alaska cruise options
                with firsthand expertise shaped by more than 40 years in the
                travel industry and travel experiences spanning over 121
                countries.
              </p>
          ...
          <div className="adg-c-why-grid">
            ...
            <div className="adg-c-why-right">
              ...
              <div className="adg-c-why-card adg-c-why-card-alt">
                ...
                <p className="adg-c-why-card-desc">
                  Azamara delivers sophisticated luxury without excessive
                  formality. This appeals strongly to travelers who want:
                </p>
                <div className="adg-c-pill-grid">
                  {[
      ...
      <section className="Asc-section Asc-bg-soft" id="Asc-who">
        <div className="Asc-container">
          <div className="Asc-section-header">
            <h2 className="Asc-h2">Is Azamara Good For Alaska Cruises?</h2>

            <div className="Asc-accent-line"></div>

            <p className="Asc-section-intro">
              For many affluent travelers, yes — particularly those seeking{" "}
              <br /> immersive luxury experiences with smaller ships and deeper
          ...
          <div className="Asc-table-wrapper">
            <table className="Asc-fleet-table">
              ...
              <tbody>
                ...
                <tr>
                  <td>
                    <strong>Alaska Immersion</strong>
                  </td>
                  <td>Excellent</td>
                  <td>Excellent</td>
                  <td>Very good</td>
        ...
        <div className="Lfsg-container">
          <div className="Lfsg-section-header">
            <h2 className="Lfsg-h2-white">
              Common Mistakes Travelers Make <br /> Booking Alaska Cruises
            </h2>
          ...
          <div className="Lfsg-mistakes-grid">
            {[
              ...
              {
                title: "Skipping Balcony Cabins",
                desc: "Private glacier and wildlife viewing can dramatically enhance the Alaska experience.",
              },
            ].map((item, i) => (
      ...
      <section className="adg-section adg-bg-soft" id="adg-best-cabins">
        <div className="adg-container">
          <div className="adg-section-header">
            <h2 className="adg-h2">Best Cabins For Azamara Alaska Cruises</h2>
          ...
          <div className="adg-split-layout">
            ...
            <div className="adg-content-card-side">
              ...
              <div className="adg-info-card">
                <div className="adg-card-meta">
                  <Ship size={28} />
                  <span className="adg-meta-label">Luxury Cabin Guidance</span>
                </div>

                <p className="adg-card-lead">
                  Choosing the right cabin can dramatically improve your Alaska
                  cruise experience.
                </p>
                ...
                <p className="adg-card-subtext">
                  Angela Hughes often recommends balcony accommodations for
                  Alaska because the scenery itself becomes part of the
                  experience.
                </p>
              </div>
            </div>
            ...
            <div className="adg-list-side">
              {[
                ...
                {
                  title:
                    "Highly recommended for glacier viewing and wildlife spotting",
                  icon: <MapPin size={20} />,
                },
          ...
          <div className="aac-excursions-grid">
            ...
            <div className="aac-excursions-content">
              ...
              <p className="aac-excursions-lead">
                Luxury travelers frequently prioritize immersive, high-end
                excursions to truly connect with the vast Alaskan wilderness.
              </p>

              <div className="aac-excursions-list">
                {[
                  {
                    text: "Helicopter glacier landings",
                    desc: "Soar over massive ice fields before landing directly on a glacier for an unforgettable walking tour.",
                  },
                  {
                    text: "Private whale watching",
                    desc: "Charter a private vessel to get up close with humpback whales and orcas, guided by marine biologists.",
                  },
                  {
                    text: "Bear viewing by floatplane",
                    desc: "Fly deep into remote national parks to watch brown bears fishing for wild salmon in pristine rivers.",
                  },
                  {
                    text: "Luxury wilderness lodges",
                    desc: "Extend your land experience with exclusive overnight stays in isolated ultra-luxury retreats.",
                  },
                  {
                    text: "Fishing charters",
                    desc: "Embark on a fully equipped private boat for world-class salmon or halibut fishing in calm coastal waters.",
                  },
                  {
                    text: "Dog sledding experiences",
                    desc: "Fly to a high-altitude glacier camp to run a team of energetic Alaskan huskies on real snow.",
                  },
                  {
                    text: "Private photography tours",
                    desc: "Gain professional guidance and private transport to capture perfect shots of dramatic landscapes and wildlife.",
                  },
                ].map((item, i) => (
            ...
            {/* RIGHT COLUMN: IMAGE */}
            <div className="aac-excursions-image-col">
              <div className="aac-excursions-img-wrapper">
                ...
                <div className="aac-image-overlay-card">
                  ...
                  <p className="aac-overlay-text">
                    "Splurge-worthy excursions in Alaska sell out up to 8 months
                    in advance. Book early to secure helicopter and private
                    charters."
                  </p>
          ...
          <div className="Adg-expert-grid">
            ...
            <div className="Adg-expert-content-col">
              ...
              <div className="Adg-expert-credentials-box">
                ...
                <div className="Adg-expert-credentials-grid">
                  {[
                    ...
                    {
                      icon: <Ship size={16} />,
                      label: "Luxury Cruise and Expedition Specialist",
                    },
                    {
                      icon: <Users size={16} />,
                    ...
                    {
                      icon: <Award size={16} />,
                      label: "Featured in Leading Global Travel Publications",
                    },
                    {
                      icon: <Users size={16} />,
                      label: "International Luxury Travel Speaker and Trainer",
                    },
                  ].map((item, i) => (
              ...
              >
                ...
                >
                  Her expertise helps clients move beyond generic cruise booking
                  toward curated luxury travel experiences designed around
                  personal preferences and elevated expectations.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="Avr-planning-left">
              ...
              <div className="Avr-planning-alert">
                ...
                <p className="Avr-planning-alert-text">
                  Trips &amp; Ships Luxury Travel delivers concierge-level
                  planning tailored specifically to affluent travelers.
                </p>
              </div>
            </div>
            ...
            <div className="Asc-help-content">
              ...
              <div className="Asc-help-grid">
                ...
                <div className="Asc-help-info">
                  ...
                  <p className="Asc-help-intro">
                    It deserves thoughtful planning, expert guidance, and a
                    luxury travel advisor who understands how to transform a
                    cruise into an unforgettable journey.
                  </p>

                  <p className="Asc-help-intro">
                    With decades of luxury travel expertise, global destination
                    knowledge, and deep cruise industry insight, Angela Hughes
                    and Trips &amp; Ships Luxury Travel help travelers
                    experience Alaska at a far more elevated level.
                  </p>
